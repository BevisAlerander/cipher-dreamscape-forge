...
export function WorldSimulationPanel({ isConnected }: Props) {
  ...
  const { canApplyDecision, applyEncryptedDecision, isBusy, message } =
    useWorldSimulation();
    ...
    >
      ...
      <section>
        <div>
          ...
          >
            <button
              disabled={disabled || !canApplyDecision}
              onClick={() =>
              ...
              style={{
                ...
                fontWeight: 600,
                fontSize: 14,
                cursor: disabled || !canApplyDecision ? "not-allowed" : "pointer",
                opacity: disabled || !canApplyDecision ? 0.5 : 1,
              }}
            >
